...
public class AddressCommand extends QueryBuilderAddress {
	 ...
	 * @throws HdacException
	 */
	public final Address addMultiSigAddress(int numberOfSigRequired, String[] publicKeys) throws HdacException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<BalanceAssetGeneral> getAddressBalances(String address) throws HdacException {
