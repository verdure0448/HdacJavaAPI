...
import com.hdactech.object.formatters.TransactionFormatter;
...
public class WalletTransactionCommand extends QueryBuilderWalletTransaction {
	...
	public List<TransactionWalletDetailed> listAddressTransactions(String address, long count, long skip, boolean verbose) throws HdacException {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List<TransactionWalletDetailed> listWalletTransaction(long count, long skip, boolean includeWatchonly, boolean verbose) throws HdacException {
	 ...
	 * @throws HdacException
	 */
	public String sendFromAddress(String fromAddress, String toAddress, List<BalanceAssetGeneral> assets) throws HdacException {
	 ...
	 * @throws HdacException
	 */
	public String sendWithMetaData(String address, List<BalanceAssetGeneral> assets, String hexMetaData) throws HdacException {
