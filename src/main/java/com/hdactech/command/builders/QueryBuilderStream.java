...
public class QueryBuilderStream extends QueryBuilderCommon {
	 ...
	 */
	protected Object executeCreate(String streamName, boolean open) throws HdacException {
	 ...
	 * @throws HdacException
	 */
	protected Object executeCreateFrom(String addressFrom, String streamName, boolean open) throws HdacException {
		HdacTestParameter.isNotNullOrEmpty("streamName", streamName);
