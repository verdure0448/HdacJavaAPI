...
public class QueryBuilderWalletTransaction extends QueryBuilderCommon {
	 ...
	 * @throws HdacException
	 */
	protected Object executeSendFromAddress(String fromAddress, String toAddress, List<BalanceAssetGeneral> assets) throws HdacException {
	 ...
	 * @throws HdacException
	 */
	protected Object executeSendWithMetaData(String address, List<BalanceAssetGeneral> assets, String hexMetaData) throws HdacException {
		HdacTestParameter.isNotNullOrEmpty("address", address);
