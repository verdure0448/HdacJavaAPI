...
public class StreamCommand extends QueryBuilderStream {
	 ...
	 */
	public String create(String streamName, boolean open) throws HdacException {
		String stringCreate = "";
	 ...
	 * @throws HdacException
	 */
	public String create(String streamName) throws HdacException {
	 ...
	 * @throws HdacException
	 */
	public String createFrom(String addressFrom, String streamName, boolean open) throws HdacException {
		String stringCreate = "";
