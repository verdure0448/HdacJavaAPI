...
public class RAWTransactionCommand extends QueryBuilderRAWTransaction {
	 ...
	 */
	public String appendRawChange(String hexString, String address) throws HdacException {
	...
	public String appendRawChange(String hexString, Address address) throws HdacException {
		if (address == null) {
	...
	public String createRawSendFrom2(String address, List<RawParam> rawParams, String[] data, String action)
			throws HdacException {
